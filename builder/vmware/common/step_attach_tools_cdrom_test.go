...
`
	...
	if vmxData["ide0:0.filename"] != "/path/to/tools.iso" {
		t.Fatalf("expected filename '/path/to/tools.iso', got '%s'", vmxData["ide0:0.filename"])
	}
...
`
	...
	if vmxData["ide0:1.filename"] != "/path/to/tools.iso" {
		t.Fatalf("expected filename '/path/to/tools.iso', got '%s'", vmxData["ide0:1.filename"])
	}
