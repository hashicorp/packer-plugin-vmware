...
variable "data_directory" {
  description = "The directory path where for the kickstart files."
  type        = string
  default     = "data/debian"
}
...
variable "memory" {
  description = "The amount of memoery in megabytes to assign to the virtual machine."
  type        = number
  default     = 2048
}
...
variable "vmx_data" {
  description = "additional data to add to the virtual machine configuration file."
  type        = map(string)
}
