...
# Setup passwordless sudo for build user
d-i preseed/late_command string \
echo "packer ALL=(ALL:ALL) NOPASSWD:ALL" > /target/etc/sudoers.d/${build_username} && chmod 0440 /target/etc/sudoers.d/${build_username}; \
